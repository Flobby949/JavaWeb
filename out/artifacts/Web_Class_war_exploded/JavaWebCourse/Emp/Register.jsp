...
<div class="row">
    ...
    <div class="col-6 p-5">
        <form action="empServlet?action=register" method="post" class="pt-lg-5 ">
            ...
            <div class="form-group row pl-3 mb-4">
                <label for="avatar" class="col-4 text-right bg-light mr-3  mb-0 pt-2" style="font-size: 20px">头像：</label>
                <select name="image" class="mr-2" onchange="document.images['avatar'].src=options[selectedIndex].value;" >
                    <option value="../../upload/001.jpg">001</option>
                    <option value="../../upload/002.jpg">002</option>
                    <option value="../../upload/003.jpeg">003</option>
                    <option value="../../upload/004.jpeg">004</option>
                    ...
                    <option value="../../upload/009.jpg">009</option>
                    <option value="../../upload/010.jpg">010</option>
                </select>
                <img src="../../upload/001.jpg" alt="头像" name="avatar" id="avatar" class="img-circle img-responsive" height="40" width="40">
            </div>

            <div class="form-group row pl-3 mb-4">
                <label for="password" class="col-4 text-right bg-light mr-3  mb-0" style="font-size: 20px">密码：</label>
                <input type="text" class="col-7 " name="pw1" id="password">
            </div>

            <div class="form-group row pl-3 mb-4">
                <label for="confirmpassword" class="col-4 text-right bg-light mr-3  mb-0" style="font-size: 20px">确认密码：</label>
                <input type="text" class="col-7" name="pw2" id="confirmpassword">
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-4">
                    <a href="LogIn.jsp" class="btn btn-block btn-primary">
                        登录
                    </a>
                </div>
            </div>
